  ...
  return (
    <>
        <div className="  xxl:w-full xxl:h-[70vh] xxl:bg-cover xxl:bg-top xxl:mt-24 xxl:relative " style={style} >
            <div className="xxl:w-[45rem] xxl:border xxl:border-[rgb(42,38,55)] text-white xxl:h-[20rem] py-7 px-6 space-y-6 rounded-xl bg-gradient-to-t from-[rgb(20,8,32)] to-[rgba(40,32,55,0.8)] xxl:absolute xxl:-bottom-[5rem] xxl:left-[10rem] ssm:static ssm:w-full ssm:h-fit">
